...
namespace VRTK
{
    ...
    ///    * If the above is not found, then a Material Color FindObjectOfType<AudioManager>().Play("KnightHit");addap Highlighter will be created on the Interactable Object GameObject at runtime.
    ///
    /// **Script Dependencies:**
    ///  * Interactions
